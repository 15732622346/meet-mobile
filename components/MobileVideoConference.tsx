...
export function MobileVideoConference({ 
  ...
  // 移除初始化获取视频尺寸的useEffect - 避免干扰CSS样式
  // React.useEffect(() => { ... }, [displayState, savedDimensions, hasScreenShare]);
    ...
    <div className="mobile-video-conference">
      ...
      <style jsx>{`
        .mobile-video-conference {
          ...
          width: 100vw;
          overflow: hidden;
          background-color: #f8f8f8; /* Jie. 20250801 修复黑色背景问题，改为浅灰色 */
          position: fixed;
          bottom: 0;
          left: 0;
          right: 0;
        ...
        .mobile-main-video {
          flex: 1;
          position: relative;
          background-color: #ffffff; /* Jie. 20250801 修复黑色背景问题，改为白色 */
          overflow: hidden;
          min-height: 0;
        }
        ...
        .empty-video-area {
          ...
          justify-content: center;
          align-items: center;
          background-color: #f0f0f0; /* Jie. 20250801 修复黑色背景问题，改为浅灰色 */
          color: #666;
          font-size: 14px;
        }
